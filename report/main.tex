...
\newcommand{\reporttitle}{Background report: XXX}
...
Almost every country in the world has committed to the Paris Agreement, a legally binding international treaty that aims to limit the global temperature increase above pre-industrial levels to 1.5 degrees Celsius: to achieve this, greenhouse gas (GHG) emissions must peak before 2025 and decline 43\% by 2030 \cite{unfcc2024}. Therefore, at the time of writing, humanity should have reached peak GHG emissions and must expect steep reductions to follow, especially in carbon dioxide which comprises most of the GHG mix. 
\\\\
For this ambitious commitment to be achieved, firms must play a part to reduce their carbon emissions. However, because the majority of a company's carbon footprint is from its value chain, reduction efforts must extend beyond its direct GHG emissions \cite{ftserussell2024}. While these indirect value chain emissions are linked to a firm's activities, they occur outside of its operational control and therefore cannot be measured directly. Moreover, as the common mantra ``what gets measured gets managed'' suggests, without good quality data across the value chain, firms will be limited in their GHG reduction effectiveness. 
\\\\
