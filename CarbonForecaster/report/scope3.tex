...
As this project is in collaboration with the London Stock Exchange Group (LSEG), the data on which my analysis is based is sourced from LSEG Datastream, a global, historical, financial database covering all major asset classes and economic indicators. The data delivery mechanisms include a Desktop application, an Excel plug-in and a feed via an application programming interface (API) available through the \textsc{refinitiv-data} Python package.\footnote{For further detail on LSEG Datastream see \href{https://www.lseg.com/en/data-analytics/financial-data/company-data/company-fundamentals-data#feature-and-benefits}{here}.}
\\\\
To ensure global coverage of firms across different industries, I use the FTSE All-World Index constituents as my universe. Originally launched in the year 2000, as of June 2024 it covers 98 percent of the world's investable market by capitalisation and contains around 4300 large and mid-cap firms \cite{FTSERussell2024}.  

\begin{figure}[H]
\centering
\caption{FTSE All-World Index}
	\begin{subfigure}[t]{0.475\textwidth}
		\centering
	      \caption{Number of instruments per year}
	      \label{fig:InstrumentsPerYear}
	      \includegraphics[width=\linewidth]{data\_coverage.png}
	      \fnote{I use instruments to account for dual-listings}
	\end{subfigure}
...
\begin{subfigure}[t]{0.475\textwidth}
    \centering
    \includegraphics[width=\linewidth, trim=4 4 4 4,clip]{problem_statement_1.png}
...
\begin{subfigure}[t]{0.475\textwidth}
    \centering
    \includegraphics[width=\linewidth, trim=4 4 4 4,clip]{problem_statement_2.png}
...
\begin{subfigure}[t]{0.475\textwidth}
    \centering
    \includegraphics[width=\linewidth, trim=4 4 4 4,clip]{problem_statement_3.png}
...
\begin{subfigure}[t]{0.475\textwidth}
    \centering
    \includegraphics[width=\linewidth, trim=4 20 4 4,clip]{problem_statement_4.png}
...
% https://www.mdpi.com/2227-7390/12/10/1504

% https://onlinelibrary.wiley.com/doi/full/10.1111/joes.12429?casa_token=IoC174PlVa4AAAAA%3AoYq0VdfaA9bLbfdAT1jOzIDjexjfZ6wr2Aof6623LAaweaBFx8fuWKxasNc0h1Khv8X04Q4e9UHf3g
