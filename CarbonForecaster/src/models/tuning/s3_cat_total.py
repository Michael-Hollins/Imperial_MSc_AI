...
def generate_param_combinations():
    ...
    y_choice_list = [['s3_cat_total'], ['s3_cat_total_intensity']]
...
# min_firms_per_fold = 2
# n_folds = 7
# y_choice = ['s3_cat_total']
# x_choice_str = 'extended'
# scaler_choice = RobustScaler() # log scaling used if scaler_choice is None. Scalar only specified for 'extended' x_choice_str
# year_lower = 2016
# year_upper = 2022
